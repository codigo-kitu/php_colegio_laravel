...
return new class extends Migration {
	...
	//php artisan make:migration --path database/migrations/Financiero/create create_pension_table
	
	//------------ CREATE MIGRATION: alter table ---------------
	//php artisan make:migration --path database/migrations/Financiero/alter alter_pension_table
	
	//=========================== NO APLICA ===========================
	
	//------------ RUN MIGRATION: create/alter table --> (public function up()) ---------------	
	//php artisan migrate --path=database/migrations/Financiero/create/create_pension_table.php
	//php artisan migrate --path=database/migrations/Financiero/alter/alter_pension_table.php
	
	//php artisan migrate (Run Todos Create)
	
	//------------ ROLLBACK MIGRATION: crete/alter(public function down()) ---------------		
	//php artisan migrate:rollback --path=database/migrations/Financiero/create/create_pension_table.php
	//php artisan migrate:rollback --path=database/migrations/Financiero/alter/alter_pension_table.php
