...
class MateriaFullController extends Controller {
	...
	public static string $ROUTE='/colegio_relaciones/estructura/materia0';
	...
	public function getIndex() {		
		...
		$style_id_column ='display:table-row';

		return view('Estructura.Materia0.Application.View.MateriaView', ['title' => 'Materia',
																		'display' => $display,
	...
	public function getSeleccionar(Request $request) {   		
		...
		if($is_validated) {			
			...
			Log::channel('stderr')->info('Id='.$id);
		
			$this->materia1 = $this->materiaLogicI->getSeleccionar(intval($id));
			
			array_push($this->materias,$this->materia1);
		...
		/*
		return view('estructura.materia.application.component.MateriaTableDataComp', ['title' => 'Materia',
																		'display' => $display,
																		'style_id_column' => $style_id_column,
																		'materia' => $this->materia1,
																		'materia_parametro_view' => $this->materiaReturnView]);	
		*/
		...
		return view('Estructura.Materia0.Application.Component.MateriaFormComp', ['title' => 'Materia',
																		'display' => $display,
																		'style_id_column' => $style_id_column,
																		'materia' => $this->materia1,
																		'materia_parametro_view' => $this->materiaReturnView]);	
